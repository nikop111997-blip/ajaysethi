...
export default function Hero({ openCartWithBundle }) {
    ...
    <section className="px-6 pt-32 pb-12 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center min-h-[90vh]">
      <div className="space-y-8 relative z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-bold tracking-tighter leading-[1.1]">
          Build Discipline,
          Stay Consistent,<br />
          <span className="text-[#ff6a3d] relative">
            Transform Daily.
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
          <button
            ...
            className="group bg-[#1a1a1a] hover:bg-[#ff6a3d] text-white px-8 py-2 rounded-lg font-medium text-lg flex items-center gap-2 transition-all shadow-xl hover:shadow-[#ff6a3d]/30 hover:-translate-y-1 w-full sm:w-auto justify-between"
          >
            Buy the Journal 
  ...
  <ArrowRight className="w-5 h-5 text-[#1a1a1a] absolute -translate-x-[150%] transition-transform duration-300 ease-in-out group-hover:translate-x-0" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 items-center gap-6 pt-8 text-md font-medium text-gray-800 border-t border-gray-200">
          <span className="flex items-center gap-2">   <Star className="w-4 h-4 text-[#ff6a3d]" />10,000+ copies sold</span>
          <span className="flex items-center gap-2"><Shield className="w-4 h-4 text-[#ff6a3d]" /> Premium Hardcover</span>
          <span className="flex items-center gap-2"><Award className="w-4 h-4 text-[#ff6a3d]" /> Real Life Results</span>
          <span className="flex items-center gap-2"><Truck className="w-4 h-4 text-[#ff6a3d]" /> Free Shipping</span>
        </div>
      </div>
