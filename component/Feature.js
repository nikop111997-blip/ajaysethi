    ...
    <section id="features" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20 space-y-4">
          <span className="text-[#ff6a3d] font-bold text-sm tracking-widest uppercase">The Framework</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuresList.map((feature, idx) => (
            <div key={idx} className="bg-gray-50 p-8 rounded-lg border border-gray-100 hover:shadow-xl hover:border-[#ff6a3d]/20 transition-all group">
              <div className="w-14 h-14 bg-white shadow-sm rounded-md flex items-center justify-center mb-6 group-hover:bg-[#ff6a3d] group-hover:-translate-y-1 transition-all duration-300">
