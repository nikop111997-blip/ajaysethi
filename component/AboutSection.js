    ...
    <section className="w-full py-20 md:py-32 px-6 md:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[2rem] overflow-hidden bg-gray-100 shadow-sm">
          {/* Replace src with Ajay's actual high-res portrait */}
          <Image
            src="https://images.unsplash.com/photo-1524854859347-bd2f42367134"
            alt="Ajay Sethi - Wellness Consultant"
            fill
            className="object-cover"
            sizes="(max-width: 768px) 100vw, 50vw"
            priority // Optional: Add priority if this section is above the fold
          />
        </div>
        ...
        <div className="flex flex-col items-start relative">
          ...
          <p className="text-gray-800 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
          ...
          <div className="w-full mt-16 flex flex-col sm:flex-row justify-between items-end gap-10">
            ...
            <div className="flex gap-12">
              <div className="flex flex-col">
                <span className="text-4xl font-bold text-[#1a1a1a] mb-1">30+</span>
                <span className="text-sm text-gray-800 font-medium">Years of Experience</span>
              </div>
              <div className="flex flex-col">
                <span className="text-4xl font-bold text-[#1a1a1a] mb-1">50k+</span>
                <span className="text-sm text-gray-800 font-medium">Lives Impacted</span>
              </div>
            </div>
            ...
            <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-2xl overflow-hidden bg-gray-100 shadow-lg flex-shrink-0">
              ...
              <Image
                src="https://images.unsplash.com/photo-1643930756178-8258419552bb" 
