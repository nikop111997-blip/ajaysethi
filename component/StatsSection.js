      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {stats.map((stat) => (
            ...
            >
              <h2 className="text-5xl md:text-6xl font-semibold mb-4 tracking-tight transition-transform duration-500 group-hover:scale-105 origin-left">
                <AnimatedCounter value={stat.value} />
              </h2>
              <h3 className="text-lg font-bold text-gray-900 mb-2 transition-colors duration-300">
                {stat.title}
              </h3>
              <p className="text-sm text-gray-800 leading-relaxed max-w-[240px]">
                {stat.description}
              </p>
            </motion.div>
          ))}
