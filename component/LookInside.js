...
export default function LookInside() {
  return (
    <section id="inside" className="py-32 bg-[#1a1a1a] text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center relative z-10">
        <div>
          <span className="text-[#ff6a3d] font-bold text-sm tracking-widest uppercase mb-4 block">Inside The Pages</span>
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">Your daily blueprint for success.</h2>

          <div className="space-y-10">
            <div className="flex gap-6">
              <div className="w-12 h-12 bg-[#2a2a2a] rounded-md flex items-center justify-center flex-shrink-0 border border-gray-800">
                <Clock className="w-6 h-6 text-[#ff6a3d]" />
              </div>
              <div>
            ...
            <div className="flex gap-6">
              <div className="w-12 h-12 bg-[#2a2a2a] rounded-xl flex items-center justify-center flex-shrink-0 border border-gray-800">
                <Target className="w-6 h-6 text-[#ff6a3d]" />
              </div>
              <div>
            ...
            <div className="flex gap-6">
              <div className="w-12 h-12 bg-[#2a2a2a] rounded-xl flex items-center justify-center flex-shrink-0 border border-gray-800">
                <Heart className="w-6 h-6 text-[#ff6a3d]" />
              </div>
              <div>
