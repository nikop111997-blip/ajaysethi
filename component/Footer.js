        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          ...
          <div className="flex flex-col items-start md:items-end gap-6">
            ...
            <nav className="flex flex-wrap items-center gap-x-6 gap-y-3">
              ...
              <Link href="/events" className="text-white/80 hover:text-[#ff6a3d] font-medium text-sm transition-colors">Events</Link>
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Instagram SVG */}
              <Link href="https://www.instagram.com/wellnesscoachajay/" target="_blank" className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white/70 hover:text-white hover:bg-[#ff6a3d] transition-all border border-white/5">
              ...
              {/* LinkedIn SVG */}
              <Link href="https://www.linkedin.com/in/wellnesscoachajay/" target="_blank" className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white/70 hover:text-white hover:bg-[#ff6a3d] transition-all border border-white/5">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* YouTube SVG */}
              <Link href="https://www.youtube.com/@kayapalat_wellness" target="_blank" className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white/70 hover:text-white hover:bg-[#ff6a3d] transition-all border border-white/5">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
